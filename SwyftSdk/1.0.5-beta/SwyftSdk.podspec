...
Pod::Spec.new do |spec|
  ...
  spec.ios.vendored_frameworks = 'SwyftSdk.framework'
  ...
  #spec.source       = { :http => "https://github.com/swyftstore/swyft-app-ios-sdk-cocoa-pod/blob/master/SwyftSdk/#{spec.version}/SwyftSdk.zip" }
